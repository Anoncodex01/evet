...
function ServiceRegistration() {
  ...
  const { title, description: serviceDescription, icon: Icon, requiresLicense } = USER_TYPES[userType];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white pt-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">{serviceDescription}</p>
        </div>
