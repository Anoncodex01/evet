...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  user_type text NOT NULL CHECK (user_type IN ('daktari', 'duka', 'wauzaji', 'agregator', 'transport', 'teacher', 'financial_advisor', 'other')),
  ...
  service_type text, -- For 'other' category to specify their service
...
CREATE TABLE IF NOT EXISTS listings (
  ...
  description text,
  location text,
  type text NOT NULL CHECK (type IN ('DAKTARI', 'DUKA', 'WAUZAJI', 'AGREGATOR', 'TRANSPORT', 'TEACHER', 'FINANCIAL_ADVISOR', 'OTHER')),
